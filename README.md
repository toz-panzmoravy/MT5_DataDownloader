...
*Download historical market data from MetaTrader 5 for XAUUSD and EURUSD with M5, M10, M15 timeframes*
...
| `TIMEFRAMES` | `M5, M10, M15` | Timeframes to download | Optimized for short-term analysis |
| `DAYS_BACK` | `365` | Historical data range | Adjustable in script |
...
> **Recommendation:** Start with default settings for XAUUSD and EURUSD M5/M10/M15 timeframes!
...
sequenceDiagram
    ...
    P->>M: Connect to MT5
    M->>P: Authentication
    P->>M: Request XAUUSD M5/M10/M15
    P->>M: Request EURUSD M5/M10/M15
...
|-----------|--------|-------------|-------------|
| **M5** | `copy_rates_range` + `copy_rates_from` | 100,000 | 5-minute candles |
| **M10** | `copy_rates_range` | Unlimited | 10-minute candles |
| **M15** | `copy_rates_range` | Unlimited | 15-minute candles |
...
| **Total Time (6 files)** | <2 minutes | 30-60 seconds |
...
| Multi-Timeframe Support | ✅ | M5, M10, M15 timeframes |
